...
//        Scanner s = new Scanner(System.in);      // оголошення поза try
//
//        try {
...
//        }
        ...
        // throw
//        try {
//            throw new Exception("Це виняток, але його обробили");
//        } catch (Exception e) {
//            System.out.println("Оброблено виняток: " + e.getMessage());
//        }
        // Консоль: Оброблено виняток: Це виняток, але його обробили
...
//            if (c2 == 0) { // это сама ошибка которую мы ищем и проверяем
        // Якщо знаменник = 0, викидаємо нашу власну помилку
//                throw new MyCustomException("Ділення на нуль неможливе!");
//            }
//            System.out.println("Результат: " + c1 / c2);
//        } catch (MyCustomException pomylka) {
        // Обробка нашої користувацької помилки
//            System.out.println("Користувацька помилка: " + pomylka.getMessage());
//        } catch (Exception pomylka) {
        // Обробка будь-яких інших помилок (наприклад, якщо ввели не число)
